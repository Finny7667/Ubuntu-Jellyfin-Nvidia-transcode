...
4) install portainer for ease of use of docker later
5) install Jellyfin with transcode enable for making it easy (just modify the file path to fit your need)
